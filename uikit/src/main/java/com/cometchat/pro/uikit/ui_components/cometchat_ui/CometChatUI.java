...
import com.cometchat.pro.uikit.ui_components.userprofile.CometChatOtherUserProfile;
...
public class CometChatUI extends AppCompatActivity implements
    ...
    public static boolean LOGGED_OUT_INDIAN_CHAT = false;

    public void logoutUser(View view) {
        CometChat.logout(new CometChat.CallbackListener<String>() {
            @Override
            public void onSuccess(String s) {
                LOGGED_OUT_INDIAN_CHAT = true;
                //Intent intent = new Intent(CometChatUI.this, MainActivity.class);
    ...
    private void startMyOwnIntent(User user) {
        CometChatOtherUserProfile.currUser = user;
        loadFragment(new CometChatOtherUserProfile());
    }
