...
public class CometChatConversationsAdapter extends RecyclerView.Adapter<CometChatConversationsAdapter.ConversationViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull ConversationViewHolder conversationViewHolder, int position) {
        ...
        if (baseMessage != null) {
            ...
            conversationViewHolder.conversationListRowBinding.messageTime.setVisibility(View.INVISIBLE);
            ...
            conversationViewHolder.conversationListRowBinding.txtUserMessage.setSingleLine(false);
        ...
        if (conversation.getConversationType().equals(CometChatConstants.RECEIVER_TYPE_USER)) {
            ...
            //Log.e("DIE", name);
            final String stringGottaFind = name + ": ";
            int index = lastMessageText.indexOf(stringGottaFind);
            if (index == 0) {
                String newString = lastMessageText.substring(stringGottaFind.length());
                conversationViewHolder.conversationListRowBinding.txtUserMessage.setText(newString);
            }
            ///////////////////////////////////////
        ...
        //R.color.my_dark_blue
        conversationViewHolder.conversationListRowBinding.messageCount.setCountBackground(Color.parseColor("#2C89F4"/*UIKitSettings.getColor()*/));
