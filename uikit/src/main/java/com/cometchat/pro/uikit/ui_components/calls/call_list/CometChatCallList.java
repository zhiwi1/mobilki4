...
public class CometChatCallList extends Fragment {
    ...
    private void checkDarkMode() {
        if(Utils.isDarkMode(getContext())) {
            ...
            tvTitle.setTextColor(getResources().getColor(R.color.my_light_blue));
            tabLayout.setBackgroundTintList(ColorStateList.valueOf(getResources().getColor(R.color.textColorWhite)));
            tabLayout.setTabTextColors(getResources().getColor(R.color.my_light_blue),getResources().getColor(R.color.textColorWhite));
        }
